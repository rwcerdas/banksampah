...
import { getPrintBankName, getPrintLogoUrl } from '@/utils/branding';
...
export function useTransactionReceipt({ selectedTransaction, formatCurrency, formatWeight, formatNumber, formatDate }) {
  const generateReceiptPDF = async () => {
    ...
    doc.setFont('helvetica', 'italic');
    doc.text(`Dicetak pada: ${printTime} oleh ${getPrintBankName()}`, pageWidth / 2, pageHeight - 10, { align: 'center' });
