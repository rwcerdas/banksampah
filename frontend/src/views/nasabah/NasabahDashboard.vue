...
import NasabahHeader from './components/NasabahHeader.vue';
import NasabahQuickActions from './components/NasabahQuickActions.vue';
import NasabahHomeStats from './components/NasabahHomeStats.vue';
import NasabahRecentActivity from './components/NasabahRecentActivity.vue';
import NasabahTracker from './components/NasabahTracker.vue';
import NasabahPriceList from './components/NasabahPriceList.vue';
import NasabahProfile from './components/NasabahProfile.vue';
import NasabahEducation from './components/NasabahEducation.vue';
import MemberCardDigital from '@/views/admin/components/MemberCardDigital.vue';
import WithdrawalModal from '@/views/admin/WithdrawalModal.vue';
import TransferModal from '@/views/admin/components/TransferModal.vue';
import NasabahBottomNavigation from './components/NasabahBottomNavigation.vue';
import NasabahNotificationModal from './components/NasabahNotificationModal.vue';
import NasabahProofViewer from './components/NasabahProofViewer.vue';
import NasabahTransactionDetail from './components/NasabahTransactionDetail.vue';
